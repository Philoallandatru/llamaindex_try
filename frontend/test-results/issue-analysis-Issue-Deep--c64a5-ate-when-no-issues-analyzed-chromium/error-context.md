...
- Name: issue-analysis.spec.ts >> Issue Deep Analysis E2E >> should show empty state when no issues analyzed
- Location: e2e\issue-analysis.spec.ts:34:3
...
Locator: locator('text=暂无已分析的 Issues').or(locator('[style*="flex-direction: column"]'))
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=暂无已分析的 Issues').or(locator('[style*="flex-direction: column"]'))
...
- generic [ref=e3]:
  ...
  - generic [ref=e13]:
    - heading "Issue 深度分析" [level=1] [ref=e14]
    - generic [ref=e15]:
      - heading "分析新 Issue" [level=2] [ref=e16]
      - generic [ref=e17]:
        - 'textbox "输入 Issue Key (例如: PROJ-123)" [ref=e18]'
        - button "开始分析" [disabled] [ref=e19]
    - generic [ref=e20]:
      - heading "已分析的 Issues" [level=2] [ref=e21]
      - generic [ref=e22]: 加载中...
```
